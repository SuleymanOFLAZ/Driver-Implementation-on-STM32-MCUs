...
//somedata
uint8_t message1[] = "Fallout New Vegas!\n";
uint8_t message2[] = "Starfield!\n";
uint8_t message3[] = "Which is your favorite game?\n";
...
int main(void)
{
	...
	while(1)
	{
		if(senddata == 1)
		{
			...
			{
				case 0:
					I2C_MasterSendData(&I2C1Handle, message1, sizeof(message1), SLAVE_ADDR);
					count++;
					break;
				case 1:
					I2C_MasterSendData(&I2C1Handle, message2, sizeof(message2), SLAVE_ADDR);
					count++;
					break;
				case 2:
					I2C_MasterSendData(&I2C1Handle, message3, sizeof(message3), SLAVE_ADDR);
					count=0;
					break;
				default:
					count=0;
